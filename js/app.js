...
const poupKeyBoard = (div1, div2, div3) => {
    document.getElementById(div1).classList.toggle('hideDiv');
    document.getElementById(div1).classList.toggle('showDiv');
    document.getElementById(div2).classList.toggle('hideDiv');
    document.getElementById(div3).classList.toggle('hideDiv');
};
